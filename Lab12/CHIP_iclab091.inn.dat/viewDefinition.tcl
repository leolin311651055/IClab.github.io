...
create_library_set -name lib_min\
   -timing\
    ...
    ${::IMEX::libVar}/mmmc/SRAM_1296X20_BC.lib\
    ${::IMEX::libVar}/mmmc/SRAM_512X128_BC.lib\
    ${::IMEX::libVar}/mmmc/SRAM_80X40_BC.lib]\
   -si\
...
create_library_set -name lib_max\
   -timing\
    ...
    ${::IMEX::libVar}/lib/typ/SRAM_1296X20_WC.lib\
    ${::IMEX::libVar}/lib/typ/SRAM_512X128_WC.lib\
    ${::IMEX::libVar}/lib/typ/SRAM_80X40_WC.lib]\
   -si\
