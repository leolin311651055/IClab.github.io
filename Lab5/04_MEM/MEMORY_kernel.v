...
module MEMORY_kernel (A0,A1,A2,A3,A4,A5,A6,A7,A8,DO0,DO1,DO2,DO3,DO4,
...
`protect
  ...
  function AddressRangeCheck;
   ...
   specify
      specparam TAA  = (134:191:311);
      specparam TWDV = (101:144:233);
      specparam TRC  = (172:244:392);
      specparam THPW = (25:36:59);
      specparam TLPW = (25:36:59);
      specparam TAS  = (44:65:110);
      specparam TAH  = (10:11:16);
      specparam TWS  = (26:39:67);
      specparam TWH  = (10:10:10);
      specparam TDS  = (35:56:98);
      specparam TDH  = (10:10:10);
      specparam TCSS = (55:81:137);
      specparam TCSH = (9:14:23);
      specparam TOE      = (28:41:68);
      specparam TOZ      = (38:53:82);
