...
set_input_delay 0 -clock clk [get_ports AR_READY]
set_input_delay 0 -clock clk [get_ports R_VALID]
set_input_delay 0 -clock clk [get_ports R_RESP]
set_input_delay 0 -clock clk [get_ports R_DATA]
set_input_delay 0 -clock clk [get_ports AW_READY]
set_input_delay 0 -clock clk [get_ports W_READY]
set_input_delay 0 -clock clk [get_ports B_VALID]
set_input_delay 0 -clock clk [get_ports B_RESP]

set_output_delay 0 -clock clk [get_ports AR_VALID] 
set_output_delay 0 -clock clk [get_ports AR_ADDR] 
set_output_delay 0 -clock clk [get_ports R_READY] 
set_output_delay 0 -clock clk [get_ports AW_VALID] 
set_output_delay 0 -clock clk [get_ports AW_ADDR] 
set_output_delay 0 -clock clk [get_ports W_VALID] 
set_output_delay 0 -clock clk [get_ports W_DATA] 
set_output_delay 0 -clock clk [get_ports B_READY] 
