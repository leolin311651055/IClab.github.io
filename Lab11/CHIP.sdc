...
# Created by write_sdc on Sat May 24 16:58:21 2025
...
set_input_delay -clock clk  -max 10  [get_ports {in_data[11]}]
set_input_delay -clock clk  -min 0  [get_ports {in_data[11]}]
set_input_delay -clock clk  -max 10  [get_ports {in_data[10]}]
set_input_delay -clock clk  -min 0  [get_ports {in_data[10]}]
set_input_delay -clock clk  -max 10  [get_ports {in_data[9]}]
set_input_delay -clock clk  -min 0  [get_ports {in_data[9]}]
set_input_delay -clock clk  -max 10  [get_ports {in_data[8]}]
...
set_output_delay -clock clk  -max 10  [get_ports out_sad]
